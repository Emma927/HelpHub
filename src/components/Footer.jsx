import { BsTwitterX, BsFacebook, BsInstagram, BsYoutube, BsWhatsapp, BsTiktok } from "react-icons/bs";
            ...
            <div className="container d-flex justify-content-between align-items-center h-100">
                <div>
                    <Link to="/" className="text-decoration-none">
                        ...
                        <span className="font-down--resp--resp fw-bold text-primary">HelpHub</span>
                    </Link>
                    <p className="font-down--resp text-primary m-0">© 2025 HelpHub LTD, All Rights Reserved</p>
                </div>
                <div className="d-flex gap-3">
                    {/* przypisanie wartości icon do zmiennej Icon */}
                    {socialMediaSites.map(({icon: Icon, address, label}) => (
                        <a key={address} href={address} target="_blank" rel="noopener noreferrer" aria-label={label}>
