...
const faq = [
    ...
    {
        question: "Czy aplikacja jest bezpłatna?", answer: "Tak. Nie pobieramy płatności za korzystanie z aplikacji",
        number: 3
    },
    {
        question: "Kiedy pojawi się nowa wersja aplikacji z możliwością dodawania ogłoszeń?",
                    ...
                    {faq.map(({question, answer, number}) =>
                        <React.Fragment key={question}>
                            <div className="question col-12">
                                <p className="font--resp">Pytanie {number}: {question}</p>
                                <button
